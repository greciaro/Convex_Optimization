...
PreProduction = [41.37, 12.63, 10.28, 1.36, 10.48, 0.28, 3.48, 40.61, 0, 18.43] # this is for year 2009

# Natural Gas consumption per country [x10^9 m^3]]
Consumption = [43.13, 2.83, 18.72, 2.83, 8.69, 0.28, 3.48, 20.87, 0.04, 20.22]  # this is for year 2009
...
Production[8] = 40.61 - ProductionTrin
